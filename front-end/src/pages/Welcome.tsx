      ...
      <div className="w-full max-w-4xl relative z-10">
        ...
        <div className="bg-white/[0.03] backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl shadow-black/50 overflow-hidden">
          ...
          <div className="relative px-8 py-10 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white tracking-tight bg-gradient-to-r from-white via-white to-cyan-200 bg-clip-text">
              Bem-vindo de volta
            </h1>
          ...
          <div className="p-8 pt-0">
            {/* User Profile */}
            <div className="flex flex-col sm:flex-row items-center gap-5 mb-8 p-6 rounded-2xl bg-white/[0.02] border border-white/5">
              <div className="relative">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-purple-500/20 flex items-center justify-center border border-white/10">
                  <User className="w-10 h-10 text-white/60" strokeWidth={1.5} />
                </div>
                <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-emerald-500 rounded-lg border-2 border-[#0a0a0f] flex items-center justify-center">
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="flex items-center justify-center sm:justify-start gap-2 mt-2 text-xs">
                  ...
                  <span className="text-white/30">Membro desde 2024</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-8">
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className="group relative p-5 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-white/10 hover:bg-white/[0.04] transition-all duration-300"
                >
                  <div
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                {onlineUsers.map((user, index) => (
                  <div
                    key={index}
                    className={`w-12 h-12 rounded-xl bg-gradient-to-br ${user.bg} p-[2px] cursor-pointer hover:scale-110 transition-transform duration-300`}
                  >
                    <div className="w-full h-full rounded-xl bg-[#0a0a0f] flex items-center justify-center text-white text-xs font-bold">
                      {user.initials}
                    </div>
                  </div>
                ))}
                <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/40 text-xs font-bold hover:bg-white/10 transition-colors cursor-pointer">
                  +239
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <Link
                to="/chat"
                className="group w-full bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-white font-semibold py-4 px-6 rounded-2xl transition-all duration-300 shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 flex items-center justify-center gap-3"
              >
              ...
              <button
                ...
                className="w-full bg-white/5 hover:bg-white/10 text-white/60 hover:text-white font-medium py-4 px-6 rounded-2xl transition-all flex items-center justify-center gap-3 border border-white/10 hover:border-white/20"
              >
